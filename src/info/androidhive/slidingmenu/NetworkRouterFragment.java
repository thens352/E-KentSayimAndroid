...
import entity.NcRouter;
import entity.RestfulErisim;

public class NetworkRouterFragment extends Fragment {
	...
	View rootView;
	public NetworkRouterFragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        rootView = inflater.inflate(R.layout.networkrouter, container, false);
		...
		temizleButon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				NetworkRouterFragment fragment = new NetworkRouterFragment();
			...
			public void onClick(View v) {
				...
				if (!((EditText) getView().findViewById(R.id.editText1))
					...
					erisim.execute(erisim.url
							+ "ncrouter/searchBarkod/"+ ((EditText) getView().findViewById(R.id.editText1)).getText().toString());
				} else
					Toast.makeText(rootView.getContext(),
		...
		barkodOkutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				args.putString("from", "NetworkRouterFragment");
	...
	public void onActivityCreated(Bundle savedInstanceState) {	
		...
		kaydetButon.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				NcRouter networkcihaz = new NcRouter();
				...
				networkcihaz.setKartPort(((EditText) getView().findViewById(
				...
				if (hataMesajý != "Lütfen" && networkcihaz.getBarkod().equals("")) {
					...
					erisim.execute(RestfulErisim.url + "ncrouter", gs);
					NetworkRouterFragment fragment = new NetworkRouterFragment();
					FragmentManager fragmentManager = getFragmentManager();
					FragmentTransaction fragmentTransaction = fragmentManager
							.beginTransaction();
