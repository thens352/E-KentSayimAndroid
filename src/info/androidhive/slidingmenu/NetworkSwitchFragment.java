...
import entity.NcSwitch;
import entity.RestfulErisim;

public class NetworkSwitchFragment extends Fragment {
	...
	View rootView;
	public NetworkSwitchFragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        rootView = inflater.inflate(R.layout.networkswitch, container, false);
		...
		temizleButon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				NetworkSwitchFragment fragment = new NetworkSwitchFragment();
			...
			public void onClick(View v) {
				...
				if (!((EditText) getView().findViewById(R.id.editText1))
					...
					erisim.execute(erisim.url
							+ "ncswitch/searchBarkod/"+ ((EditText) getView().findViewById(R.id.editText1)).getText().toString());
				} else
					Toast.makeText(rootView.getContext(),
		...
		barkodOkutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				args.putString("from", "NetworkSwitchFragment");
	...
	public void onActivityCreated(Bundle savedInstanceState) {	
		...
		kaydetButon.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				NcSwitch networkcihaz = new NcSwitch();
				...
				networkcihaz.setPortSayisi(((EditText) getView().findViewById(
				...
				if (hataMesajý != "Lütfen" && networkcihaz.getBarkod().equals("")) {
					...
					erisim.execute(RestfulErisim.url + "ncswitch", gs);
					NetworkSwitchFragment fragment = new NetworkSwitchFragment();
					FragmentManager fragmentManager = getFragmentManager();
					FragmentTransaction fragmentTransaction = fragmentManager
							.beginTransaction();
