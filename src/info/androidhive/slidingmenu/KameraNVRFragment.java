...
public class KameraNVRFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.kameranvr, container, false);
		...
		temizleButon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				KameraNVRFragment fragment = new KameraNVRFragment();
		...
		for (String marka : db.getAll("e6", "MARKA")) {
			markaList.add(marka);
		}
			...
			public void onClick(View v) {
				...
				if (!((EditText) getView().findViewById(R.id.editText1))
					...
					erisim.execute(erisim.url
							+ "ksnvr/searchBarkod/"+ ((EditText) getView().findViewById(R.id.editText1)).getText().toString());
				} else
					Toast.makeText(rootView.getContext(),
		...
		barkodOkutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				args.putString("from", "KameraNVRFragment");
		...
		kaydetButon.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (hataMesajý != "Lütfen" && kamera.getBarkod().equals("")) {
					...
					erisim.execute(RestfulErisim.url + "ksnvr", gs);
					KameraNVRFragment fragment = new KameraNVRFragment();
					FragmentManager fragmentManager = getFragmentManager();
					FragmentTransaction fragmentTransaction = fragmentManager
							.beginTransaction();
