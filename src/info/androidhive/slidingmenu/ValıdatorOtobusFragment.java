...
public class ValýdatorOtobusFragment extends Fragment {
	...
	public ValýdatorOtobusFragment() {
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		temizleButon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				ValýdatorOtobusFragment fragment = new ValýdatorOtobusFragment();
		...
		barkodOkutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				args.putString("from", "ValýdatorOtobusFragment");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		kaydetButon.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (hataMesajý != "Lütfen" && otobus.getBarkod().equals("")) {
					hataMesajý += " giriniz";
