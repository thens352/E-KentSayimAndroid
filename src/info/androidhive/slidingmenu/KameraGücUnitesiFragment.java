...
import entity.KsGucUnitesi;
import entity.RestfulErisim;

public class KameraGücUnitesiFragment extends Fragment {
	...
	public KameraGücUnitesiFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.kameragucunitesi, container, false);
		...
		temizleButon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				KameraGücUnitesiFragment fragment = new KameraGücUnitesiFragment();
		...
		for (String marka : db.getAll("e7", "MARKA")) {
			markaList.add(marka);
		}
			...
			public void onClick(View v) {
				...
				if (!((EditText) getView().findViewById(R.id.editText1))
					...
					erisim.execute(erisim.url
							+ "ksgucunitesi/searchBarkod/"+ ((EditText) getView().findViewById(R.id.editText1)).getText().toString());
				} else
					Toast.makeText(rootView.getContext(),
		...
		barkodOkutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				args.putString("from", "KameraGücUnitesiFragment");
	...
	public void onActivityCreated(Bundle savedInstanceState) {	
		...
		kaydetButon.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				KsGucUnitesi kamera = new KsGucUnitesi();
				...
				if (hataMesajý != "Lütfen" && kamera.getBarkod().equals("")) {
					...
					erisim.execute(RestfulErisim.url + "ksgucunitesi", gs);
					KameraGücUnitesiFragment fragment = new KameraGücUnitesiFragment();
					FragmentManager fragmentManager = getFragmentManager();
					FragmentTransaction fragmentTransaction = fragmentManager
							.beginTransaction();
