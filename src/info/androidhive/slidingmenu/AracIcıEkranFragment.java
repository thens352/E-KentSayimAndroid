...
public class AracIcýEkranFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		temizleButon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				AracIcýEkranFragment fragment = new AracIcýEkranFragment();
		...
		barkodOkutButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				args.putString("from", "AracIcýEkranFragment");
	...
	public void onActivityCreated(Bundle savedInstanceState) {	
		...
		kaydetButon.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (hataMesajý != "Lütfen" && aracekran.getBarkod().equals("")) {
					hataMesajý += " giriniz";
